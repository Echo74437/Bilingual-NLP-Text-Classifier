...
dataset1 = pd.read_csv("Datasets/CSINTSY-G28-DATASET.csv")
dataset2 = pd.read_csv("Datasets/[GROUP 16] sentence_ID 780 - 832 - Sheet1.csv")
dataset3 = pd.read_csv("Datasets/final_annotations1.csv")
dataset4 = pd.read_csv("Datasets/final_annotations2.csv")
